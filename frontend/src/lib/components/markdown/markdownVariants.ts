...
export const variantClasses: Record<MarkdownContentVariant, string> = {
	...
	plan: [
		'prose prose-sm dark:prose-invert max-w-none text-[13px] leading-[1.55] text-foreground',
		...
		'prose-blockquote:my-3 prose-blockquote:border-l-2 prose-blockquote:border-primary/40 prose-blockquote:bg-muted/40 prose-blockquote:px-3 prose-blockquote:py-2 prose-blockquote:text-[12.5px] prose-blockquote:font-normal prose-blockquote:not-italic',
		'prose-a:break-words prose-code:break-words prose-code:text-[12px] prose-code:font-medium prose-code:before:content-none prose-code:after:content-none',
		'prose-pre:my-3 prose-pre:max-w-full prose-pre:overflow-x-auto prose-pre:rounded-md prose-pre:bg-muted prose-pre:p-3 prose-pre:text-xs',
