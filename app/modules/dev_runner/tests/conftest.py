...
from app.modules.dev_runner.routes.stats import router as stats_router
...
def patch_db(mock_db):
    with patch("app.modules.dev_runner.services.db_service.db_service.db_path", mock_db):
        yield
