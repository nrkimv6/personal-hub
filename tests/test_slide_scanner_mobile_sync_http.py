...
from app.modules.slide_scanner.routers import mobile_review_router, mobile_sync_router
...
def test_mobile_review_transition_http_approve_delete_handoff(slide_scanner_http_context, monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(mobile_review_module, "handoff_item_to_slides", lambda _db, _item_id: 501)
