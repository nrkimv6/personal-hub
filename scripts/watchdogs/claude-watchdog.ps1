...
function Start-ClaudeWorker {
    ...
    & $VenvPython "$ProjectRoot\scripts\services\register_process.py" --pid $actualPid --ppid $PID --name "claude-worker" --exe $VenvPython --role "claude" -ErrorAction SilentlyContinue
